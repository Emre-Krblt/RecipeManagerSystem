...
class ModifyRecipe implements Command {
    ...
    public ModifyRecipe(Recipe recipe, String newName, String newSize, List<String> newIngredients, String newInstructions,
